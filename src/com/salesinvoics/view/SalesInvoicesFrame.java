...
import com.salesinvoices.controller.InvoiceController;
...
public class SalesInvoicesFrame extends javax.swing.JFrame {
    ...
    public ArrayList<SalesInvoice> getInvoice() {
        if (invoices == null) invoices = new ArrayList<>();
        return invoices;
    }

    public void setInvoice(ArrayList<SalesInvoice> invoices) {
        this.invoices = invoices;
    }

    public InvoiceTableModel getInvoicesTableModel() {
        if (invoicesTableModel == null) {
            invoicesTableModel = new InvoiceTableModel(getInvoice());
        }
        return invoicesTableModel;
    }

    public void setInvoiceTableModel(InvoiceTableModel invoicesTableModel) {
        this.invoicesTableModel = invoicesTableModel;
    }

    public JLabel getCustomeerNameLabel() {
        return customerNameLabel;
    }

    public JLabel getInvoiceDateeLabel() {
        return invoiceDateLabel;
    }

    public JLabel getInvoiceNumbLabel() {
        return invoiceNumLabel;
    }

    public JTable getInvoiceTablee() {
        return invoiceTable;
    }

    public JLabel getInvoiceTotallLabel() {
        return invoiceTotalLabel;
    }

    public JTable getLineeTable() {
        return lineTable;
    }

    public InvoiceController getControlller() {
        return controller;
    }
    
    public int getNextInvoiceNumb() {
        int num = 0;
        
        for (SalesInvoice invoice : getInvoice()) {
